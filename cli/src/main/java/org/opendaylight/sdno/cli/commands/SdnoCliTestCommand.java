 ...
 */
package org.opendaylight.sdno.cli.commands;

import org.apache.karaf.shell.commands.Command;
import org.apache.karaf.shell.commands.Option;
import org.apache.karaf.shell.console.AbstractAction;
import org.opendaylight.sdno.cli.api.SdnoCliCommands;
...
public class SdnoCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(SdnoCliTestCommand.class);
    protected final SdnoCliCommands service;

    public SdnoCliTestCommand(final SdnoCliCommands service) {
